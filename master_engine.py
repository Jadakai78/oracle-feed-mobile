...
def get_dashboard():
    html_content = (
        ...
        '          <p>The independent Hostile Sentinel continuously patrols incoming feeds, neutralizing decay traps and cascade vectors before execution.</p>'
...
if __name__ == "__main__":
    ...
    import os
    port = int(os.environ.0 if "PORT" not in os.environ else os.environ.get("PORT", 10000))
